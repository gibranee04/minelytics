================================================================================
⚠️ INSTRUKSI UTAMA UNTUK AI (MANDATORY STRICT RULES) ⚠️
1. TUGAS UTAMA: Ubah DAN perbarui tampilan visual UI aplikasi 
   sesuai dengan spesifikasi desain Bugatti di bawah ini.
2. JANGAN UBAH LOGIKA: Dilarang keras mengubah, menghapus, atau memodifikasi fungsi, 
   state management, API fetching, routing, logika bisnis, atau komponen fungsional yang sudah ada.
3. PRINSIP KERJA: Hanya ganti class styling, komponen visual, 
   warna, tipografi, dan layouting. Kode backend/fungsi harus tetap 100% utuh.
================================================================================
